        ...
        <div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div className="bg-slate-900 px-8 py-10 text-center">
                    <div className="inline-flex items-center justify-center h-20 w-20 rounded-full bg-white/10 backdrop-blur text-white text-3xl font-bold shadow-lg ring-4 ring-white/10 mb-4">
                        {initials}
                    </div>
                    <h2 className="text-2xl font-bold text-white">{user?.name || "Admin"}</h2>
                    <p className="text-slate-300 mt-1 text-sm capitalize">{user?.role || "admin"}</p>
                </div>
                ...
                <div className="p-8 space-y-6">
                    ...
                    {/* Edit Button */}
                    <Link href="/admin-dashboard/profile/edit" className="flex items-center justify-center gap-2 w-full py-3.5 px-4 bg-slate-900 hover:bg-slate-800 text-white font-semibold rounded-xl transition-all duration-200 shadow-sm active:scale-[0.98]">
