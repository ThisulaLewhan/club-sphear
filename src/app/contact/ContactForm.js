            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
                <div className="bg-zinc-900 rounded-[2rem] p-8 sm:p-10 text-white shadow-xl h-full flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <h2 className="text-3xl font-bold mb-2">Reach Out directly</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        >
                            {loading ? (
                                ...
                                <>
                                    Send Message
                                    <svg className="w-5 h-5 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                                </>
                            )}
                        </button>
                    </form>
